...
public class Selenium_Day5_Greens_Technology2 {
	...
	public static void main(String[] args) {
		...
		WebElement microStategy = driver.findElement(By.xpath("//span[text()='COGNOS Certification Training']"));
		
		a.doubleClick(microStategy).perform();
